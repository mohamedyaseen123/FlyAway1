...
//		
//		Thread.sleep(3000);
//		Registration_page.email.sendKeys("yaseenyazs@outlook.com");
//		
//		Thread.sleep(3000);
...
//		
//		Thread.sleep(3000);
//		Registration_page.name.sendKeys(" yassen");
//		
//		Thread.sleep(3000);
//		Registration_page.address.sendKeys("vanyiga nagar street, koyambatu");
//		
//		Thread.sleep(3000);
//		Registration_page.city.sendKeys("chennai");
...
//		Register_confirm.login.click();
		...
		Thread.sleep(3000);
		Login_page.Loginemail.sendKeys("yassenyazs@outlook.com");
